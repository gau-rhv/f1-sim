...
const monza: TrackData = {
  ...
  minSpeed: 105,
  pitLanePoints: [
    [0, 100], [0, 50], [15, 25], [45, 25], [60, 15]
  ],
  pitEntryProgress: 0.92,
  pitExitProgress: 0.08,
  pitBoxes: [
    [20, 25], [28, 25], [36, 25], [44, 25]
  ]
};
...
const silverstone: TrackData = {
  ...
  minSpeed: 98,
  pitLanePoints: [
    [340, 345], [300, 315], [240, 315], [180, 315], [120, 315], [100, 335]
  ],
  pitEntryProgress: 0.95,
  pitExitProgress: 0.05,
  pitBoxes: [
    [260, 315], [230, 315], [200, 315], [170, 315]
  ]
};
...
const spa: TrackData = {
  ...
  minSpeed: 95,
  pitLanePoints: [
    [35, 160], [100, 160], [180, 160], [210, 160], [230, 145]
  ],
  pitEntryProgress: 0.94,
  pitExitProgress: 0.06,
  pitBoxes: [
    [110, 160], [135, 160], [160, 160], [185, 160]
  ]
};
...
const bahrain: TrackData = {
  ...
  minSpeed: 96,
  pitLanePoints: [
    [400, 325], [350, 315], [250, 315], [150, 315], [100, 315], [65, 330]
  ],
  pitEntryProgress: 0.93,
  pitExitProgress: 0.07,
  pitBoxes: [
    [300, 315], [250, 315], [200, 315], [150, 315]
  ]
};
